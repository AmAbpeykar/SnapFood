<x-layout>
    ...
    <form action=" {{route('login')}}" class="w-3/6 h-4/6 text-center m-auto border-2 p-10 mt-28" method="POST">
        @csrf
        ...
        <div class="relative h-14 z-0 mb-5 w-full">
            ...
            <select id="underline_select" name="role_id"
                ...
                <option class="bg-indigo-700 hover:text-bold text-white" value="2">Admin</option>
