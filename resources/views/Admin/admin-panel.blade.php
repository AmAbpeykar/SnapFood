<x-layout>
    ...
    <div>
        ...
        <div class="w-full flex justify-evenly">
            <div class="w-2/5 text-center">
                ...
                <a href=" {{ route('new_restaurant_category') }}" class="text-blue-600">Add New Restaurant Category</a>
            ...
            <div class="w-2/5 text-center">
                ...
                <a href=" {{ route('new_food_category') }}" class="text-blue-600">Add New Food Category</a>
    ...
    <div class="w-full flex justify-center mt-10">
        <div class="w-2/5 text-center">
            ...
            <a href=" {{ route('new-offer') }}" class="text-blue-600">Add New Offer</a>
